...
// 		this.currentGroupName = event.currentTarget.dataset.sliderGroupName;
// 		this.updateThumbs();
// 	}

// 	updateThumbs() {
// 		const thumbsList = document.querySelectorAll(
// 			`${this.imagesSelector}[data-slider-group-name=${this.currentGroupName}]`
// 		);
// 		const prototype = document.querySelector(
// 			".js-slider__thumbs-item--prototype"
// 		);

// 		document.querySelector(".js-slider__thumbs").innerHTML = "";
...
// 			if (
// 				thumbImg.src ===
// 				this.sliderRootElement.querySelector(".js-slider__image").src
// 			) {
